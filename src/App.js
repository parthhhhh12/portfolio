    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 text-white">
      ...
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          isScrolled ? "bg-gray-900/95 backdrop-blur" : "bg-transparent"
        }`}
      >
              ...
              <div className="bg-gray-700 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {certifications.map((cert, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 p-3 bg-gray-600 rounded"
                    >
                  ...
                  {[...Array(5)].map((_, dotIndex) => (
                    <div
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-300 ${
                        dotIndex < skill.dots ? skill.color : "bg-gray-600"
                      }`}
                    ></div>
                  ))}
                </div>
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="space-y-3">
                    ...
                    {project.highlights.map((highlight, idx) => (
                      <div
                        key={idx}
                        className="flex items-start gap-3 p-3 bg-gray-600 rounded"
                      >
      ...
      <section id="contact" className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-gray-800 rounded-lg p-8">
                <p className="text-gray-300 mb-8 leading-relaxed">
                  I'm actively seeking opportunities in data engineering roles
                  where I can apply my cloud-native skills and continue growing
            ...
            src="/img.jpeg"
            alt="Parth"
            className="size-24 mx-auto rounded-full mb-4 object-cover"
          />
